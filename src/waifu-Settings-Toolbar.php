...
class live2D_Settings_Toolbar {
    ...
    public function live_2d_settings_toolbar_init() {
        ...
        add_settings_section(
            ...
            __('工具栏设置','toolbar_settings_section'), // title
        ...
        add_settings_field(
            'showToolMenu', // id
            __('工具栏','toolbar_settings_showToolMenu'), // title
        ...
        add_settings_field(
            'canCloseLive2d', // id
            __('关闭看板娘按钮','toolbar_settings_canCloseLive2d'), // title
        ...
        add_settings_field(
            'canSwitchModel', // id
            __('模型切换按钮','toolbar_settings_canSwitchModel'), // title
        ...
        add_settings_field(
            ...
            __('材质切换按钮','toolbar_settings_canSwitchTextures'), // title
        ...
        add_settings_field(
            ...
            __('一言切换按钮','toolbar_settings_canSwitchHitokoto'), // title
        ...
        add_settings_field(
            ...
            __('看板娘截图按钮','toolbar_settings_canTakeScreenshot'), // title
        ...
        add_settings_field(
            ...
            __('返回首页按钮','toolbar_settings_canTurnToHomePage'), // title
        ...
        add_settings_field(
            ...
            __('跳转关于页按钮','toolbar_settings_canTurnToAboutPage'), // title
        ...
        add_settings_field(
            'waifuToolFont', // id
            __('工具栏图标大小(px)','toolbar_settings_waifuToolFont'), // title
        ...
        add_settings_field(
            'waifuToolLine', // id
            __('工具栏行高(px)','toolbar_settings_waifuToolLine'), // title
        ...
        add_settings_field(
            'waifuToolTop', // id
            __('工具栏顶部边距(px)','toolbar_settings_waifuToolTop'), // title
        ...
        add_settings_field(
            'waifuToolColor', // id
            __('工具栏图标颜色','toolbar_settings_waifuToolColor'), // title
        ...
        add_settings_field(
            'waifuToolHover', // id
            __('鼠标触碰时图标颜色','toolbar_settings_waifuToolHover'), // title
    ...
    public function showToolMenu_callback() {
        ...
        <label for="showToolMenu-0"><input type="radio" name="live_2d_settings_option_name[showToolMenu]" id="showToolMenu-0" value="1" <?php echo $checked; ?>> <?php esc_html_e('显示','settings_Show') ?></label><br>
        <?php $checked = ( isset( $this->live_2d__options['showToolMenu'] ) && $this->live_2d__options['showToolMenu'] === false ) ? 'checked' : '' ; ?>
        <label for="showToolMenu-1"><input type="radio" name="live_2d_settings_option_name[showToolMenu]" id="showToolMenu-1" value="0" <?php echo $checked; ?>> <?php esc_html_e('隐藏','settings_Hide') ?></label></fieldset> <?php
    }
    ...
    public function canCloseLive2d_callback() {
        ...
        <label for="canCloseLive2d-0"><input type="radio" name="live_2d_settings_option_name[canCloseLive2d]" id="canCloseLive2d-0" value="1" <?php echo $checked; ?>> <?php esc_html_e('开启','settings_Open') ?></label><br>
        <?php $checked = ( isset( $this->live_2d__options['canCloseLive2d'] ) && $this->live_2d__options['canCloseLive2d'] === false ) ? 'checked' : '' ; ?>
        <label for="canCloseLive2d-1"><input type="radio" name="live_2d_settings_option_name[canCloseLive2d]" id="canCloseLive2d-1" value="0" <?php echo $checked; ?>> <?php esc_html_e('关闭','settings_Close') ?></label></fieldset> <?php
    }
    ...
    public function canSwitchModel_callback() {
        ...
        <label for="canSwitchModel-0"><input type="radio" name="live_2d_settings_option_name[canSwitchModel]" id="canSwitchModel-0" value="1" <?php echo $checked; ?>> <?php esc_html_e('显示','settings_Show') ?></label><br>
        <?php $checked = ( isset( $this->live_2d__options['canSwitchModel'] ) && $this->live_2d__options['canSwitchModel'] === false ) ? 'checked' : '' ; ?>
        <label for="canSwitchModel-1"><input type="radio" name="live_2d_settings_option_name[canSwitchModel]" id="canSwitchModel-1" value="0" <?php echo $checked; ?>> <?php esc_html_e('隐藏','settings_Hide') ?></label></fieldset> <?php
    }
    ...
    public function canSwitchTextures_callback() {
        ...
        <label for="canSwitchTextures-0"><input type="radio" name="live_2d_settings_option_name[canSwitchTextures]" id="canSwitchTextures-0" value="1" <?php echo $checked; ?>> <?php esc_html_e('显示','settings_Show') ?></label><br>
        <?php $checked = ( isset( $this->live_2d__options['canSwitchTextures'] ) && $this->live_2d__options['canSwitchTextures'] === false ) ? 'checked' : '' ; ?>
        <label for="canSwitchTextures-1"><input type="radio" name="live_2d_settings_option_name[canSwitchTextures]" id="canSwitchTextures-1" value="0" <?php echo $checked; ?>> <?php esc_html_e('隐藏','settings_Hide') ?></label></fieldset> <?php
    }
    ...
    public function canSwitchHitokoto_callback() {
        ...
        <label for="canSwitchHitokoto-0"><input type="radio" name="live_2d_settings_option_name[canSwitchHitokoto]" id="canSwitchHitokoto-0" value="1" <?php echo $checked; ?>> <?php esc_html_e('显示','settings_Show') ?></label><br>
        <?php $checked = ( isset( $this->live_2d__options['canSwitchHitokoto'] ) && $this->live_2d__options['canSwitchHitokoto'] === false ) ? 'checked' : '' ; ?>
        <label for="canSwitchHitokoto-1"><input type="radio" name="live_2d_settings_option_name[canSwitchHitokoto]" id="canSwitchHitokoto-1" value="0" <?php echo $checked; ?>> <?php esc_html_e('隐藏','settings_Hide') ?></label></fieldset> <?php
    }
    ...
    public function canTakeScreenshot_callback() {
        ...
        <label for="canTakeScreenshot-0"><input type="radio" name="live_2d_settings_option_name[canTakeScreenshot]" id="canTakeScreenshot-0" value="1" <?php echo $checked; ?>> <?php esc_html_e('显示','settings_Show') ?></label><br>
        <?php $checked = ( isset( $this->live_2d__options['canTakeScreenshot'] ) && $this->live_2d__options['canTakeScreenshot'] === false ) ? 'checked' : '' ; ?>
        <label for="canTakeScreenshot-1"><input type="radio" name="live_2d_settings_option_name[canTakeScreenshot]" id="canTakeScreenshot-1" value="0" <?php echo $checked; ?>> <?php esc_html_e('隐藏','settings_Hide') ?></label></fieldset> <?php
    }
    ...
    public function canTurnToHomePage_callback() {
        ...
        <label for="canTurnToHomePage-0"><input type="radio" name="live_2d_settings_option_name[canTurnToHomePage]" id="canTurnToHomePage-0" value="1" <?php echo $checked; ?>> <?php esc_html_e('显示','settings_Show') ?></label><br>
        <?php $checked = ( isset( $this->live_2d__options['canTurnToHomePage'] ) && $this->live_2d__options['canTurnToHomePage'] === false ) ? 'checked' : '' ; ?>
        <label for="canTurnToHomePage-1"><input type="radio" name="live_2d_settings_option_name[canTurnToHomePage]" id="canTurnToHomePage-1" value="0" <?php echo $checked; ?>> <?php esc_html_e('隐藏','settings_Hide') ?></label></fieldset> <?php
    }
    ...
    public function canTurnToAboutPage_callback() {
        ...
        <label for="canTurnToAboutPage-0"><input type="radio" name="live_2d_settings_option_name[canTurnToAboutPage]" id="canTurnToAboutPage-0" value="1" <?php echo $checked; ?>> <?php esc_html_e('显示','settings_Show') ?></label><br>
        <?php $checked = ( isset( $this->live_2d__options['canTurnToAboutPage'] ) && $this->live_2d__options['canTurnToAboutPage'] === false ) ? 'checked' : '' ; ?>
        <label for="canTurnToAboutPage-1"><input type="radio" name="live_2d_settings_option_name[canTurnToAboutPage]" id="canTurnToAboutPage-1" value="0" <?php echo $checked; ?>> <?php esc_html_e('隐藏','settings_Hide') ?></label></fieldset> <?php
    }
